...
This module provides functions to seamlessly integrate docx_redline with
...
def from_python_docx(
    ...
    """Create a docx_redline Document from a python-docx Document.

    This enables workflows where you create or modify documents with python-docx
    and then add tracked changes with docx_redline, without needing to save
    to disk in between.
    ...
    Returns:
        A docx_redline Document ready for tracked change operations
    ...
    Example:
        ...
        >>> from docx_redline.compat import from_python_docx
        >>>
        ...
        >>>
        >>> # Convert to docx_redline for tracked edits
    ...
    # Create docx_redline Document from the in-memory bytes
    return Document(buffer, author=author)


def to_python_docx(doc: Document, validate: bool = True) -> Any:
    """Convert a docx_redline Document back to a python-docx Document.

    This is useful when you need python-docx's document creation features
    after making tracked changes with docx_redline.

    Args:
        doc: A docx_redline Document
    ...
    Example:
        >>> from docx_redline import Document
        >>> from docx_redline.compat import to_python_docx
        >>>
    ...
    # Save docx_redline document to bytes
